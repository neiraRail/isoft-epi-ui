    ...
    <v-row>
      ...
      <v-col cols="12" md="8">
        <v-text-field
          ...
          validate-on-blur
          :rules="[formRules.validarTexto,formRules.noBlankTextRequired]"
        />
      </v-col>
      <v-col cols="12" md="4">
        <p>Apellidos</p>
      ...
      <v-col cols="12" md="8">
        <v-text-field
          ...
          validate-on-blur
          :rules="[formRules.validarTextoyNumero,formRules.noBlankTextRequired]"
      ...
      <v-col cols="12" md="8">
        <v-text-field
          ...
          type="text"
          :rules="[formRules.validarSexo,formRules.noBlankTextRequired]"
        />
      ...
      <v-col cols="12" align="center" justify="center">
        <v-btn color="success" @click="guardarPaciente()">Registrar Paciente</v-btn>     
      </v-col>
      <v-col cols="12" align="center" justify="center">
